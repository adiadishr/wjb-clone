...
const data = [
  {
    ...
    content: (
      <div>
        <h3 className="scroll-m-20 text-2xl md:text-4xl font-semibold tracking-tight mb-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <TimelineImage src="/1.jpeg" />
          <TimelineImage src="/2.jpeg" />
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <TimelineImage src="/3.jpeg" />
          <TimelineImage src="/4.jpeg" />
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <TimelineImage src="/5.jpeg" />
          <TimelineImage src="/6.jpeg" />
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <TimelineImage src="/7.jpeg" />
          <TimelineImage src="/8.jpeg" />
        </div>
      </div>
    ),
  },
