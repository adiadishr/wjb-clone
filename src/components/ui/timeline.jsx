    ...
    (<div
      ...
      <div ref={ref} className="relative container w-[90%] mx-auto pb-48 md:mt-[-2rem]">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-36 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute left-0 md:left-3 w-10 rounded-full bg-white flex items-center justify-center">
                <div
            ...
            <div className="relative pl-15 md:pl-4 w-full">
              <h3
        ...
        <div
          ...
          className="absolute md:left-8 left-4.5 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] ">
          <motion.div
            style={{
