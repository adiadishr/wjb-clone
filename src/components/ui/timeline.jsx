  ...
  return (
    (<div
      ...
      <div className="container mx-auto px-4">
        ...
        <div data-aos='fade-up' data-aos-delay='100' className={`leading-tight text-4xl md:text-5xl font-pt-serif tracking-tight text-center mb-8`}>
          Here's how it all <span className="italic">works</span>
        </div>
      </div>
      <div ref={ref} className="relative container px-4 mx-auto pb-48 md:mt-[-2rem]">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-36 md:gap-10">
            <div
              ...
              <h3
                className="hidden md:block text-2xl md:pl-20 md:text-4xl text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
