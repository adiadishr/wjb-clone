  ...
  return (<>
    <div className="relative bg-white">
      <div className="container mx-auto px-4 py-24 md:py-36">
        ...
        <div data-aos='fade-up' data-aos-delay='100' className={`leading-tight text-4xl md:text-5xl font-pt-serif tracking-tight text-center ${page ? 'mb-24' : 'mb-8'}`}>
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 items-center gap-8">
          {services.map((service, index) => (
            <div data-aos='fade-up' data-aos-delay={`${100 + (index * 50)}`} key={index} className="bg-white z-10 p-8 col-span-1 relative cursor-pointer group overflow-hidden h-96 md:h-72">
              <Image fill className="object-cover group-hover:saturate-[100%] transition-all saturate-0 duration-[600ms] ease-quart group-hover:scale-110 -z-10 pointer-events-none selection:bg-transparent group-hover:blur-[2px]" alt="background" src={service.src} />
              <div className="z-10 flex flex-col justify-end h-full">
                ...
                <p className="leading-5 md:leading-7 text-sm md:text-base line-clamp-4 mb-[-6rem] md:mb-[-7rem] duration-500 ease-quart group-hover:mb-0 text-white">
                  {service.description}
                </p>
